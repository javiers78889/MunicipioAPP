        ...
        <div className="row gx-0 align-items-center">
            ...
            <div className="d-flex flex-wrap">
              ...
              <div className="ps-3">
                <a href="mailto:example@gmail.com" className="text-muted small">
                  <i className="fas fa-envelope textMun  me-2"></i>chame.municipio@gmail.com
                </a>
              </div>
            </div>
          </div>
          <div className="col-lg-4 text-center text-lg-end">
            <div className="d-flex justify-content-end">
              <div className="d-flex borderMun  pe-3">
                <a className="btn p-0 textMun me-3" href="#">
              ...
              <div className="dropdown ms-3">
                <a href="#" className="dropdown-toggle text-dark" data-bs-toggle="dropdown">
                  <small>
                    <i className="fas fa-globe-europe textMun me-2"></i> Español
                  </small>
                </a>
